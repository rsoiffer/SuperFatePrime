...
#### Powers List
See the [Powers List](powers) page for more details.
...
Resources represent advantages that can be used up: a limited reserve of strength, a minor NPC ally who can only do so much to help, or a powerful weapon that easily runs out of ammunition. Resource Traits work slightly differently than other Traits. Each resource Trait is rated with multiple dice of the same size. Whenever you roll the trait, you cross off one of these dice. Once you've crossed off all the dice, you can't use the resource any more. The resource recovers over time at a rate determined by the GM. You usually get the resource back in the next scene, or once your character has had time to rest and recover, whatever makes the most sense for the story.
...
* Emotional: This is the stress of rage, fear, or grief. Once this exceeds d12, you are lost to your emotions.
* Mental: This is the stress of confusion or psychic control. Once this exceeds d12, you can no longer control your actions.
* Physical: This is the stress of pain or fatigue. Once this exceeds d12, you collapse unconscious and may die.
...
Characters aren't only defined by their strengths. Even superheroes have flaws, weaknesses, and limits to their powers. SuperFate Prime uses two mechanics to represent a character's weakness.
